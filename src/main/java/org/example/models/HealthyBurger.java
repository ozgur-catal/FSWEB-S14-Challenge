...
public class HealthyBurger extends Hamburger{
    ...
    public double itemizeHamburger(){
        System.out.println(this + (getHealthyExtra1Name()==null?"":"HealthyAddition1:" + getHealthyExtra1Name()) + (getHealthyExtra2Name()==null?"":"HealthyAddition2:" + getHealthyExtra2Name())+ '\n' + "Price:" + getPrice());
        return getPrice();
    }
